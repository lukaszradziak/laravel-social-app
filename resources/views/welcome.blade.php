                            ...
                            <div
                                ...
                                <div class="lg:py-24">
                                    ...
                                    >
                                        ...
                                        <span class="ml-4 text-sm">About App</span>
                                    ...
                                    <h1
                                        ...
                                        <span class="block">{{ __('Social Network') }}</span>
                                        <span
                                    ...
                                    <div class="mt-10 sm:mt-12">
                                        ...
                                        >
                                            ...
                                            <p class="mt-3 text-sm text-gray-300 sm:mt-4">Start your free account,
                                                no credit card necessary. By providing your email, you agree to our <a
                                                    href="#"
                                ...
                                <div class="pt-6">
                                    <div class="flow-root bg-gray-50 rounded-lg px-6 pb-8">
                                        <div class="-mt-6">
                                            ...
                                            <h3 class="mt-8 text-lg font-medium text-gray-900 tracking-tight">Simple
                                                Queues</h3>
                                            <p class="mt-5 text-base text-gray-500">
                                    ...
                                    <div class="flow-root bg-gray-50 rounded-lg px-6 pb-8">
                                        <div class="-mt-6">
                                            ...
                                            <h3 class="mt-8 text-lg font-medium text-gray-900 tracking-tight">Advanced
                                                Security</h3>
                                            <p class="mt-5 text-base text-gray-500">
                                                Ullam laboriosam est voluptatem maxime ut mollitia commodi. Et
                                ...
                                <div class="pt-6">
                                    <div class="flow-root bg-gray-50 rounded-lg px-6 pb-8">
                                        <div class="-mt-6">
                                            ...
                                            <h3 class="mt-8 text-lg font-medium text-gray-900 tracking-tight">Powerful
                                                API</h3>
                                            <p class="mt-5 text-base text-gray-500">
                                    ...
                                    <div class="flow-root bg-gray-50 rounded-lg px-6 pb-8">
                                        <div class="-mt-6">
                                            ...
                                            <h3 class="mt-8 text-lg font-medium text-gray-900 tracking-tight">Database
                                                Backups</h3>
                                            <p class="mt-5 text-base text-gray-500">
                                                Quia qui et est officia cupiditate qui consectetur. Ratione similique
                                                et impedit ea ipsum et.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="flex-1">
                                        ...
                                        >
                                            ...
                                            <p class="mt-3 text-base text-gray-500">
                                                ...
                                                asperiores porro quaerat doloribus, eveniet dolore. Adipisci tempora
