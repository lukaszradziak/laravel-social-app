<div class="md:grid grid-cols-3 gap-6">
    <div class="rounded-lg shadow ring-1 ring-black ring-opacity-5 overflow-hidden bg-white mb-4">

        <div class="px-5 py-5 bg-gray-50 space-y-6 sm:flex sm:space-y-0 sm:space-x-10 sm:px-8 border-b">
            <div class="flow-root">
                <button
                    wire:click.prevent="$toggle('modalOpen')"
        ...
        <div class="bg-white px-5 py-3 h-96 overflow-y-auto">
            @foreach ($chats as $chat)
                ...
                >
                    ...
                    <svg
                        viewBox="0 0 120 120"
                        class="absolute w-4 h-4 left-14 top-14"
                        style="margin: -3px"
                    >
                        <circle
                            cx="50"
                            cy="50"
                            r="45"
                            class="userStatus{{ $chat->user()?->id }}"
                            fill="@if ($chat->user()?->is_online) green @else silver @endif"
                            stroke="#fff"
                            stroke-width="10"
                        />
                    </svg>
    ...
    <div class="col-span-2">
        <div class="rounded-lg shadow ring-1 ring-black ring-opacity-5 overflow-hidden">
            @if ($activeChat)
    ...
    @if ($modalOpen)
        ...
        >
            <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                ...
                <div
                    class="inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full sm:p-6">
