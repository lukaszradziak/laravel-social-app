            ...
            <div class="mt-8 lg:mt-0 lg:col-start-1 lg:col-span-7 lg:row-start-1 lg:row-span-3">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 lg:gap-8">
                    <img
                        ...
                        alt="{{ $user->name }}"
                        class="lg:col-span-2 lg:row-span-2 rounded-lg w-full"
                    >
                </div>
            </div>
            ...
            <div class="lg:col-span-5">
                <div class="mt-10">
                    ...
                    <div class="mt-4 prose prose-sm text-gray-500">
                        <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Quasi consequatur aliquam
                            voluptatum, expedita nostrum dolore vel nulla accusantium fugit quaerat dolores itaque
                            voluptatem eius ducimus? Delectus voluptate velit odio quis.</p>
                    </div>
                </div>
